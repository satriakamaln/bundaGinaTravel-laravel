        ...
        <div class="container py-5">
            <div class="row align-items-center">
                <div class="col-lg-7 mb-5 mb-lg-0">
                    <div class="mb-4">
                        <h6 class="text-primary text-uppercase" style="letter-spacing: 5px;">Jadwal Travel</h6>
                    </div>
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-body rounded-bottom bg-white p-5">
                            <form>
                                ...
                                <div>
                                    <button class="btn btn-primary btn-block py-3" type="submit">Order Sekarang</button>
                                </div>
                            </form>
                        </div>
                    </div>

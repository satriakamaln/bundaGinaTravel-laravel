...
<div class="container-fluid py-5">
    <div class="container py-5">
        <div class="text-center mb-3 pb-3">
            <h6 class="text-primary text-uppercase" style="letter-spacing: 5px;">Data Order</h6>
                ...
                <div class="contact-form bg-white" style="padding: 30px;">
                    ...
                    <form action="{{ route('customer.order.update', $order->id) }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="text-center">
                            <button class="btn btn-primary py-3 px-4" type="submit" id="sendMessageButton">Upload Bukti</button>
                        </div>
                    </form>
                </div>
            </div>

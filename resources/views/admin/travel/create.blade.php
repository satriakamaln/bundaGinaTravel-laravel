        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form method="post" action="{{ route('admin.travel.store') }}">
                            <div class="modal-body">
                                ...
                                <div class="form-group ">
                                    ...
                                    <select name="mobil_id" class="form-control select2 select2-hidden-accessible"
                                        ...
                                        @foreach ($mobil as $m)
                                       <option value="{{ $m->id }}" data-select2-id="34">{{ $m->merk }},  {{ $m->jenis }} {{ $m->tipe }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group ">
                                    ...
                                    <select name="user_id" class="form-control select2 select2-hidden-accessible"
                                        ...
                                        <option selected="selected" data-select2-id="3">--Pilih Sopir--
                                            ...
                                            @foreach ($driver as $s)
                                            <option value="{{ $s->id }}" data-select2-id="34">{{ $s->name }}</option>
                                            @endforeach
                                    </select>
                                </div>
                                <div class="form-group">

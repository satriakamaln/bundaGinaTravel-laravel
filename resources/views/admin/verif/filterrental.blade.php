...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Order Terverifikasi </h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                    <li class="breadcrumb-item active">Cetak Order Terverifikasi </li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form method="post" action="{{ route('admin.report.verifdaterental') }}" target="_blank">
                            ...
                            <div class="modal-footer justify-content-between">
                                <td>
                                    <a type="button" href="{{ route('admin.verif.index') }}"

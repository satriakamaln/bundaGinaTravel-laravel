...
<body>
    ...
    <div class="container">
        ...
        <div class="isi">
            <h2 style="text-align:center;">LAPORAN USER</h2>
            ...
            <table id="myTable" class="table table-bordered table-striped dataTable no-footer text-center" role="grid"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">{{ $d->nohp }}</td>
                        <td style="text-align: left">
                            @if($d->role == 0)Pelanggan
                            @elseif($d->role == 1)Admin
                            @elseif($d->role == 2)Driver
                            @endif
                        </td>
            ...
            <div class="ttd">
                ...
                <br>
                <br>
                <h5 style="text-decoration:underline; margin:0px">Gina Istiqomah</h5>
